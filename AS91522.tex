...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node[inner sep=0] at (0,0) {\includegraphics[width=0.8\textwidth]{Images/Loop the loop graph.png}};sdfsdfsdfsdfsfd
	...
	Other factors include surface area contacting air ($A$), and the coefficient of lift ($C_L$, determined by shape and angle of attack).\\
